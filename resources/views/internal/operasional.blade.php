<x-dashboard-layout>
    ...
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="border-b border-gray-200 pb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">Monitoring lokasi latihan resmi, penanggung jawab ranting, dan
                    distribusi jumlah warga aktif di
                    {{ auth()->user()->ranting?->nama_ranting ? 'Ranting ' . auth()->user()->ranting->nama_ranting : 'Setiap Ranting' }}.
                </p>
            </div>
                ...
                <div
                    ...
                    <div class="p-7 space-y-5 flex-grow">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest">Pelatih</p>
            ...
            <div class="bg-white rounded-2xl w-full max-w-md p-6 shadow-2xl border border-gray-100 space-y-4">
                <div class="flex items-center justify-between border-b border-gray-100 pb-3">
                    <h3 class="font-bold text-slate-950 text-sm uppercase tracking-wide">
                        <i class="fa-solid fa-map-pin text-red-600 mr-1"></i> Form Ranting Baru
                    </h3>
                    <button onclick="tutupModal()" class="text-gray-400 hover:text-gray-600 text-sm cursor-pointer">
        ...
        {{-- Form Hidden khusus Hapus (Agar tidak bentrok nested form di HTML) --}}
        <form id="formDeleteRanting" method="POST" class="hidden">
            @csrf
            @method('DELETE')
        </form>
        ...
        <div id="modalEditRanting"
            ...
            <div class="bg-white rounded-2xl w-full max-w-md p-6 shadow-2xl border border-gray-100 space-y-4">
                <div class="flex items-center justify-between border-b border-gray-100 pb-3">
                    <h3 class="font-bold text-slate-950 text-sm uppercase tracking-wide">
                        <i class="fa-solid fa-pen-to-square text-amber-500 mr-1"></i> Edit Data Ranting
                    </h3>
                ...
                <form id="formEditRanting" method="POST" class="space-y-4 text-xs">
                    ...
                    <div class="flex items-center justify-between pt-2 border-t border-gray-100">
                        <!-- Tombol Hapus mengarahkan ke formDeleteRanting via attribute HTML5 'form' -->
                        <button type="submit" form="formDeleteRanting"
            ...
            <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 sm:p-8 transform transition-all scale-100">
                ...
                <div class="bg-slate-50 rounded-xl p-4 border border-slate-200 space-y-3 mb-6">
                    <div>
                        ...
                        <div
                            ...
                            <button
                                ...
                                class="text-slate-400 hover:text-red-600 transition text-xs cursor-pointer"
                                title="Salin">
                    ...
                    <p class="text-[11px] text-amber-600 italic bg-amber-50 p-2 rounded border border-amber-200">
                        ...
                        tidak akan menampilkan password ini lagi setelah Anda menutup modal ini.
                    </p>
                </div>
    ...
    <script>
        ...
        // Modal Edit (Injeksi Data & Action Form)
        function bukaModalEdit(id, nama, ketua, pelatih, lokasi, kontak) {
            ...
            document.getElementById('formDeleteRanting').action = "/internal/operasional/" + id;

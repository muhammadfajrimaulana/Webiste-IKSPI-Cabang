                        ...
                        <table class="w-full text-left text-xs text-gray-600">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <tr class="hover:bg-slate-50/40 transition">
                                    <td class="p-3 font-bold text-slate-900 uppercase">Wahyu Supono</td>
                                    <td class="p-3 text-slate-500"><i
                                            class="fa-solid fa-location-dot text-gray-400 mr-1"></i> Tanah Abang</td>
                                    <td class="p-3">
                                        <span
                                            ...
                                            <i class="fa-regular fa-file-pdf"></i> <span>iks.pdf</span>
                                        </span>
                                    </td>
                                ...
                                <tr class="hover:bg-slate-50/40 transition">
                                    <td class="p-3 font-bold text-slate-900 uppercase">Lukman Pratama</td>
                                    <td class="p-3 text-slate-500"><i
                                            class="fa-solid fa-location-dot text-gray-400 mr-1"></i> Kemayoran</td>
                                    <td class="p-3">
                                        <span
                                            class="inline-flex items-center space-x-1.5 text-red-600 font-bold bg-red-50 px-2 py-0.5 rounded border border-red-100 text-[11px]">
                                            <i class="fa-regular fa-file-pdf"></i> <span>iks.pdf</span>
